...
public final class GameCalendar {
    ...
    private static float inv60 = 1/60f;
    ...
    //Julian day number.
    private long JDN;
    private float tMult = 1f;

    private String dateString = "";

    public GameCalendar(int year, int month, int day, int hour, int minute, float tMult){
    ...
    public float getFractionOfDay() {
        return (float)getSecondInDay() / SECONDS_IN_DAY;
    }
